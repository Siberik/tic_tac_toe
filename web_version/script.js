...
/* Функция эвристической оценки состояния.*/
...
/* Эта функция проверяет, выигрывает ли конкретный игрок*/
...
/* Эта функция проверяет, выигрывает ли человек или компьютер. */
...
/* Ход считается действительным, если выбранная ячейка пуста */
...
/* Установить ход в ячейке, если координаты верны*/
...
/* *** Функция AI, которая выбирает лучший ход *** */
